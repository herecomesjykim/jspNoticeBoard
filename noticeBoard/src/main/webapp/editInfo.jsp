		...
		<div class="row">
			<form method="post" action="editAction.jsp">
				<table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color:#eeeeee"; text-align:center;">회원정보 수정양식</th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							<td><input type="email" class="form-control" placeholder="이메일" name="userEmail" maxlength="50" value="<%=user.getUserEmail() %>" ></td>
